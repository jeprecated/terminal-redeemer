...
- Document terminology, decisions, controller behavior, statuses, timing, security, troubleshooting, and initial non-goals without overstating support.
...
- Provide an operator smoke matrix for session counts, pickup/drop/undo, dynamic changes, concurrent interaction, local close, reconnect, degraded mapping, duplicate suppression, and ownership-safe close.
